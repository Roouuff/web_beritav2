...
<section class="py-5 bg-primary text-white">
    <div class="container py-4 text-center">
        <h1 class="display-5 fw-bold mb-3">
            <i class="bi bi-boxes me-2"></i> {{ config('app.name', 'Laravel') }}
        </h1>
    ...
    <div class="container text-center">
        @auth
            <div class="alert alert-success d-inline-block px-5 shadow-sm">
                ...
                Halo, <strong>{{ auth()->user()->name }}</strong>! Kamu sedang login.
                <a href="{{ route('dashboard') }}" class="btn btn-sm btn-success ms-3">Dashboard</a>
            </div>
        @else
            <div class="alert alert-info d-inline-block px-5 shadow-sm">
                ...
                <a href="{{ route('register') }}" class="btn btn-sm btn-outline-primary ms-1">Register</a>
            </div>
        @endauth
    </div>
</section>
