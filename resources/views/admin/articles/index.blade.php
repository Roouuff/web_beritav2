                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <h6 class="font-weight-bold mb-1">
                                <a href="{{ route('berita.show', $article->slug) }}" target="_blank" class="text-primary text-decoration-none" title="Lihat Detail Berita">
                                    {{ $article->title }} <i class="fas fa-external-link-alt fa-xs ml-1 text-muted"></i>
                                </a>
                            </h6>
