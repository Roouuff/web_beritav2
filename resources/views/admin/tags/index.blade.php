...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Daftar Tag / Label Berita</h6>
    </div>
    <div class="card-body">
            ...
            <table class="table table-bordered table-striped" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><code class="text-secondary">{{ $tag->slug }}</code></td>
                        <td class="text-center">
                            ...
                            <form action="{{ route('tags.destroy', $tag->id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger btn-sm shadow-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus tag ini? Data yang terhapus tidak dapat dikembalikan!')">
                    ...
                    <tr>
                        <td colspan="4" class="text-center py-4 text-muted">
                            <i class="fas fa-tags fa-2x mb-2 d-block"></i> Belum ada data tag. Silakan tambahkan tag baru.
                        </td>
                    </tr>
                    @endforelse
                </tbody>
