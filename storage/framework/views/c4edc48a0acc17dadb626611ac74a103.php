...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="<?php echo e(route('articles.index')); ?>" class="btn btn-secondary btn-sm shadow-sm">
...
unset($__errorArgs, $__bag); ?>" id="title" name="title" value="<?php echo e(old('title')); ?>" placeholder="Masukkan judul berita utama" required autofocus>
...
unset($__errorArgs, $__bag); ?>" id="content" name="content" rows="10" placeholder="Tuliskan berita secara mendalam..." required><?php echo e(old('content')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group mb-0">
                ...
                <a href="<?php echo e(route('articles.index')); ?>" class="btn btn-secondary shadow-sm">Batal</a>
            </div>
        </form>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\webberita\resources\views/admin/articles/create.blade.php ENDPATH**/ ?>